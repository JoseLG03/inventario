        ...
        <article class="pad_left3">
            <?php
                ...
                $consulta=mysql_query("SELECT equipo.serie, equipo.tipo_eq, equipo.marca, equipo.modelo, equipo.nombre, equipo.capacidad, 
                        ...
                        WHERE status.id_status=equipo.status and instalaciones.id_instalaciones=equipo.id_instalaciones and instalaciones.id_instalaciones='$_REQUEST[instalaciones]'")
